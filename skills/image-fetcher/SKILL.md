...
description: >
  ...
  Organizes assets in the departmen's reference folder.
description_pt-BR: >
  ...
  Organiza os assets na pasta de referência do departmen.
description_es: >
  ...
  Organiza los assets en la carpeta de referencia del departmen.
type: hybrid
version: "1.0.0"
mcp:
...
Use the Asset Fetcher when you need to acquire visual assets for content creation. It supports three acquisition modes: web image search, live website screenshots via Playwright, and organizing user-provided files. All assets are saved to the departmen's reference or output folder with descriptive filenames and metadata.
...
3. **Asset Organization** -- Save all acquired assets with descriptive filenames in the departmen's reference/ or output/ folder.
