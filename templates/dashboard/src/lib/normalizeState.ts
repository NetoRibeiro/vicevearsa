import type { DepartmenState, Agent } from "@/types/state";
 ...
 * Find agent by id.
 */
export function findAgent(state: DepartmenState, agentId: string): Agent | undefined {
 ...
 */
export function getWorkingAgent(state: DepartmenState): Agent | undefined {
