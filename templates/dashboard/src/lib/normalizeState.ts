import type { DepartmentState, Agent } from "@/types/state";
 ...
 * Find agent by id.
 */
export function findAgent(state: DepartmentState, agentId: string): Agent | undefined {
 ...
 */
export function getWorkingAgent(state: DepartmentState): Agent | undefined {
