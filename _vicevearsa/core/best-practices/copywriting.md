...
- **Icons**: Use relative paths from Iconify (https://icon-sets.iconify.design/) (e.g., lucide:check-circle, ph:arrow-right-bold). Icons must be functional anchors for scannability or CTAs. If a symbol is purely decorative, cut it.
...
- **Emoji**: Strictly avoid colorful or cartoonish emojis. They degrade authority and feel juvenile. Use Iconify paths for professional UI-style markers instead.
